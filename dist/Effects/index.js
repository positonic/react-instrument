...
function (_React$Component) {
  ...
  _createClass(Effects, [{
    ...
    value: function toggleFilter(instrumentId, filterIndex) {
      ...
      return function (evt) {
        _this2.props.toggleFilter(instrumentId, filterIndex);
      };
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var instrumentId = this.props.instrumentId;
      return _react.default.createElement("div", {
        className: this.props.className + ' clearBoth'
      }, _react.default.createElement("h3", null, "Filters"), this.props.instrument.filters.map(function (filter, index) {
        var type = filter.hasOwnProperty('tunaType') ? filter.tunaType : filter.type;
        return _react.default.createElement(Filter, {
          key: index,
          type: type,
          active: filter.active,
          onChange: _this3.toggleFilter(instrumentId, index)
        });
