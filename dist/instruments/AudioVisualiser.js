...
function (_React$Component) {
  ...
  function AudioVisualiser(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioVisualiser).call(this, props));
    ...
    var cueOut = _this.secondsToSamples(_this.source.buffer.duration, sampleRate);

    _this.peaks = (0, _webaudioPeaks.default)(_this.source.buffer, samplesPerPixel, isMono, cueIn, cueOut, 8);
  ...
  _createClass(AudioVisualiser, [{
    ...
    value: function renderPeaks() {
      ...
      this.canvasHook = new _CanvasHook.default(peaks, offset, this.peaks.bits, canvasColor);
    }
  }, {
    ...
    value: function render() {
      ...
      }, "click"), _react.default.createElement("canvas", {
        ref: this.canvas,
