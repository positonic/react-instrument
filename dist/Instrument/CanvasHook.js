  ...
  _createClass(CanvasHook, [{
    ...
    value: function hook(canvas, prop, prev) {
      ...
      for (var i = 0; i < len; i += 1) {
        var minPeak = this.peaks[(i + this.offset) * 2] ? this.peaks[(i + this.offset) * 2] / maxValue : 0;
        var maxPeak = this.peaks[(i + this.offset) * 2] ? this.peaks[(i + this.offset) * 2 + 1] / maxValue : 0;
