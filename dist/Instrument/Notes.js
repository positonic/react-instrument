...
// The default
var NotesBlock = _styledComponents.default.div(_templateObject(), function(
  props
) {
  return props.blockWidth;
});

var Note = _styledComponents.default.div(
  _templateObject2(),
  function(props) {
  ...
  (function(_React$Component) {
    ...
    function Notes(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(Notes).call(this, props)
      );
      _this.drawNote = _this.drawNote.bind(_assertThisInitialized(_this));
      _this.OnResizeStop = _this.OnResizeStop.bind(
    ...
    _createClass(Notes, [
      {
        ...
        value: function OnResizeStop(index, duration) {
          ...
          return function(evt, direction, refToElement, delta, position) {
            ...
            _this2.props.changeSequencedNote(index, null, newNoteLength, null);
          };
        }
      },
      {
          ...
          return _react.default.createElement(
            _reactRnd.Rnd,
            {
              ...
              selectedNotes: [index]
                  ...
                  _this3.props.changeSequencedNote(
                    index,
                    newMidiNumber,
                    note.duration,
                    newBeatNumber
