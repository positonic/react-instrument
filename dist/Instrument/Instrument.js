...
var _InstrumentSelector = _interopRequireDefault(
  require("./controls/InstrumentSelector")
);
...
var _DeleteInstrument = _interopRequireDefault(
  require("./controls/DeleteInstrument")
);

var _BeatsPerLoopSelector = _interopRequireDefault(
  require("./controls/BeatsPerLoopSelector")
);

var _ToggleMoreSettings = _interopRequireDefault(
  require("./controls/ToggleMoreSettings")
);
...
var _InstrumentData = require("./InstrumentData");
...
var SequencedKeyboardContainer = _styledComponents.default.div(
  _templateObject()
);
    ...
    (function(_React$Component) {
      ...
      function WithParameters() {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(WithParameters).apply(this, arguments)
        );
      }
...
function withSequencedKeyboard(
  SequencedKeyboard,
  SoundProvider,
  Parameters,
  Effects
    ...
    (_temp = _class =
      ...
      (function(_React$Component2) {
        ...
        function _class(props) {
          ...
          _this.deleteInstrument = _this.deleteInstrument.bind(
            _assertThisInitialized(_this)
          );
          _this.changeInstrument = _this.changeInstrument.bind(
            _assertThisInitialized(_this)
          );
          _this.toggleMoreSettings = _this.toggleMoreSettings.bind(
            _assertThisInitialized(_this)
          );
          _this.toggleEffects = _this.toggleEffects.bind(
            _assertThisInitialized(_this)
          );
          _this.updateSynthFilterState = _this.updateSynthFilterState.bind(
            _assertThisInitialized(_this)
          );
          _this.updateSynthOscState = _this.updateSynthOscState.bind(
            _assertThisInitialized(_this)
          );
          _this.updateEnvelopeState = _this.updateEnvelopeState.bind(
            _assertThisInitialized(_this)
          );
          _this.onTick = _this.onTick.bind(_assertThisInitialized(_this));
          _this.setSelectedNotes = _this.setSelectedNotes.bind(
            _assertThisInitialized(_this)
          );
          _this.deleteSelectedNotes = _this.deleteSelectedNotes.bind(
            _assertThisInitialized(_this)
          );
          _this.changeGridSequence = _this.changeGridSequence.bind(
            _assertThisInitialized(_this)
          );
          _this.toggleFilter = _this.toggleFilter.bind(
            _assertThisInitialized(_this)
          );
          _this.changeSequencedNote = _this.changeSequencedNote.bind(
            _assertThisInitialized(_this)
          );
          _this.state = {
            showAnalyser: false,
          ...
          _this.props.timeSequencer.subscribeToTicks(
            props.instrumentId,
            _this.onTick
          );
        ...
        _createClass(_class, [
          ...
          },
          {
            ...
            value: function getInstrumentSelector(
              instrumentNames,
              currentInstrument
            ) {
              if (instrumentNames.length) {
                return _react.default.createElement(
                  _InstrumentSelector.default,
                  {
        ...
        this.props.setInstrumentGain(this.props.instrumentId, value);
                ...
                function(state) {
                  return _objectSpread({}, state, {
                    instrument: _objectSpread({}, state.instrument, {
                      oscillators: state.instrument.oscillators.map(function(
                        item,
                        index
                      ) {
                        if (index !== oscId) {
            ...
            value: function updateEnvelopeState(envelopeId, property, value) {
              ...
              this.setState(
                function(state) {
                  return _objectSpread({}, state, {
                    instrument: _objectSpread({}, state.instrument, {
                      envelopes: state.instrument.envelopes.map(function(
                        item,
                        index
                      ) {
                        if (index !== envelopeId) {
          ...
          value
              ...
              this.setState(function(state) {
                return _objectSpread({}, state, {
                  instrument: _objectSpread({}, state.instrument, {
                    filters: state.instrument.filters.map(function(
                      item,
                      index
                    ) {
                      if (index !== filterId) {
                      ...
                      if (property === "filter") newFilter.props.value = value;
                        ...
                        newFilter.props.Q = value;
                      else console.log("Error unexpected propery", property); //console.log("newFilter.props is ", property, newFilter.props);
          ...
          },
          {
            ...
            value: function onTick(tick) {
              ...
              if (instrument.isMuted !== true) {
                ...
                var loopTick = (0, _utils.convertTickToLoopTick)(
                  tick.tickNumber,
                  ticksPerLoop
                );
                ...
                if (notes.length) {
                  var sequencedNotes = (0, _utils.getSequencedNotes)(
                    notes,
                    beatTimeTick
                  );
                  ...
                  if (sequencedNotes.length) {
                    sequencedNotes.forEach(function(note) {
                      if (note.on === true || note.on === 1) {
                        ...
                        _utils.getNoteLengthSecondsFromBeats)(
                          note.duration,
                          tick.bpm
                        );

                        _this2.playNoteAtTime(
                          note.midiNumber,
                          tick.time,
                          noteLengthInSeconds
                        );
          ...
          },
          {
            ...
            value: function toggleMoreSettings() {
              ...
              var state = this.state; //console.log(state, showMoreSettings, this.state.instrument);
          ...
          },
          {
            ...
            value: function deleteSelectedNotes(notesToDelete) {
              var instrument = this.state.instrument;
              var updateInstrument = JSON.parse(JSON.stringify(instrument));
              var updatedInstrumentNotesPhrase = (0,
              _InstrumentData.deleteNotes)(
                updateInstrument.notes[updateInstrument.notesIndex],
                notesToDelete
              );
              updateInstrument.notes[
                updateInstrument.notesIndex
              ] = updatedInstrumentNotesPhrase;
              this.setState({
          ...
          {
            key: "changeSequencedNote",
            value: function changeSequencedNote(
              index,
              midiNumber,
              noteLengthBeats,
              beatNumber
              ...
              var updateInstrument = JSON.parse(JSON.stringify(instrument));
              var updatedInstrumentNotesPhrase = (0,
              _InstrumentData.buildChangedNotes)(
                updateInstrument.notes[updateInstrument.notesIndex],
                index,
                midiNumber,
                beatNumber,
          ...
          },
          {
            ...
            value: function changeGridSequence(
              midiNumber,
              instrumentId,
              noteLengthBeats,
              beatNumber
            ...
            value: function render() {
              ...
              var _this$props = this.props,
                ...
                changeSequencedKeyboardView =
                  _this$props.changeSequencedKeyboardView,
              ...
              return _react.default.createElement(
                ...
                _react.default.createElement(SoundProvider, {
                  ...
                  render: function render(_ref) {
                    ...
                    _this3.playNoteAtTime = playNoteAtTime;
                    var pianoSettings = {
                      playNote: playNote,
                    ...
                    if (isArmed && midi)
                      _this3.setActiveMidi(playNote, stopNote);
                    var instrumentParameters;
                    if (Parameters && instrument.showMoreSettings)
                      instrumentParameters = _react.default.createElement(
                        Parameters,
                        {
                          updateSynthFilterState: _this3.updateSynthFilterState,
                          updateSynthOscState: _this3.updateSynthOscState,
                          updateEnvelopeState: _this3.updateEnvelopeState,
                          instrument: instrument,
                          oscillators: instrument.oscillators
                        }
                      );
                    ...
                    if (Effects && instrument.showEffects === true)
                      instrumentEffects = _react.default.createElement(
                        Effects,
                        {
                          instrument: instrument,
                          instrumentId: instrumentId,
                          toggleFilter: _this3.toggleFilter
                        }
                      );
                ...
                width: instrumentWidth
                          ...
                          _react.default.createElement(
                            _DeleteInstrument.default,
                            {
                              deleteInstrument: _this3.deleteInstrument
                            }
                          ),
                          _react.default.createElement(
                            "h3",
                            ...
                            _react.default.createElement(
                              ...
                              {
                                style: activateStyle,
                                onClick: _this3.activateInstrument
                              },
                              _react.default.createElement("i", {
                          ...
                          (function(
                            ...
                            if (showAnalyser)
                              return Visualiser(
                                samplesBuffers.filter(function(o) {
                                  return o.name === currentInstrument;
                                })[0].buffer
                              );
                          })(
                            _this3.state.showAnalyser,
                            currentInstrument,
                            samplesBuffers
                          ),
                          _this3.getInstrumentSelector(
                            instrumentNames,
                            currentInstrument
                          ),
                          _react.default.createElement(SequencedKeyboard, {
                            ...
                            audioContext: _this3.props.audioContext,
                            setSelectedNotesState: _this3.setSelectedNotes,
                            playNote: playNote,
                            stopNote: stopNote,
                            pianoSettings: pianoSettings,
                            noteGridSettings: _this3.noteGridSettings,
                            activeView: instrument.view,
                            isArmed: isArmed,
                            deleteSelectedNotesState:
                              _this3.deleteSelectedNotes,
                            changeSequencedKeyboardView: changeSequencedKeyboardView,
                            changeBeatsPerLoop: _this3.props.changeBeatsPerLoop,
                            toggleShowEffects: _this3.props.toggleShowEffects,
                            instrumentId: instrumentId,
                            changeGridSequence: _this3.changeGridSequence,
                            changeSequencedNote: _this3.changeSequencedNote,
                            render: function render(_ref2) {
                              var changeView = _ref2.changeView,
                                _changeNumberOfBeatsLoop =
                                  _ref2.changeNumberOfBeatsLoop,
                              ...
                              return _react.default.createElement(
                                ...
                                _react.default.createElement(
                                  ...
                                  _react.default.createElement(
                                    ...
                                    _this3.getToggleParametersButton(
                                  ...
                                  instrumentEffects,
                                  _react.default.createElement(
                                    _BeatsPerLoopSelector.default,
                                    {
                                      noLoopBeats: instrument.beatsPerLoop,
                                      changeNumberOfBeatsLoop: function changeNumberOfBeatsLoop(
                                        noOfBeats
                                      ) {
