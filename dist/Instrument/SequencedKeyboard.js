...
function (_React$Component) {
  ...
  function SequencedKeyboard(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SequencedKeyboard).call(this, props));
    ...
    _this.changeNumberOfBeatsLoop = _this.changeNumberOfBeatsLoop.bind(_assertThisInitialized(_this));
    ...
    _this.deleteSelectedNotes = _this.deleteSelectedNotes.bind(_assertThisInitialized(_this)); //This is too slow - props.timeSequencer.subscribeToTicks(this.onTick);
  ...
  _createClass(SequencedKeyboard, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState, nextContext) {
      if ((0, _ShouldUpdate.instrumentsChanged)(nextProps, this.props) || nextProps.pianoSettings !== this.props.pianoSettings || nextProps.noteGridSettings !== this.props.noteGridSettings) {
        return true;
      } else {
        return false;
      }
    ...
    value: function getView() {
      ...
      if (activeView === 'grid') {
        ...
        return _react.default.createElement("div", null, _react.default.createElement(PianoDarkTheme, null, _react.default.createElement(_reactPiano.Piano, {
          disabled: !isArmed,
    ...
    value: function getNoteGrid() {
      ...
      if (activeView !== 'grid') return null;else {
        var gridWidthPixels = noteGridSettings.gridWidthPixels,
            ...
            instrumentType = noteGridSettings.instrumentType,
            gridHeightPixels = noteGridSettings.gridHeightPixels;
        return _react.default.createElement(NoteGridBox, null, _react.default.createElement(_Timeline.default, {
