...
var NoteGridBackground = _styledComponents.default.div(
  _templateObject(),
  function(props) {
...
var PianoKey = _styledComponents.default.div(_templateObject3(), function(
  props
) {
  ...
  (function(_React$Component) {
    ...
    function NoteGrid(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(NoteGrid).call(this, props)
      );
      _this.state = {
        startTime: 0,
        bpm: _this.props.bpm,
      ...
      _this.calculateXPos = _this.calculateXPos.bind(
        _assertThisInitialized(_this)
      );
      ...
      _this.convertMouseToCoordinates = _this.convertMouseToCoordinates.bind(
        _assertThisInitialized(_this)
      );
    ...
    _createClass(NoteGrid, [
      ...
      },
      {
        ...
        value: function calculateXPos() {
          ...
          var loopBeat = (0, _utils.getLoopBeat)(
            beatsPassed,
            this.props.beatsPerLoop
          );
          ...
          return _react.default.createElement(
            ...
            _react.default.createElement(
              ...
              _react.default.createElement(
                ...
                _react.default.createElement(NoteGridBackground, {
                  gridWidth: gridWidth
                }),
