export default {
    ...
    isMuted: false,
    notes: [
        [{ beat_time: 1, duration: 8, midiNumber: 60, on: 1 }],
        [
            { beat_time: 1, duration: 3.5, midiNumber: 60, on: 1 },
            { beat_time: 5, duration: 1.5, midiNumber: 64, on: 1 },
            { beat_time: 6.5, duration: 2.475, midiNumber: 60, on: 1 },
            { beat_time: 9, duration: 3.9875, midiNumber: 64, on: 1 },
            { beat_time: 13, duration: 4, midiNumber: 62, on: 1 }
        ]
    ],
    beatsPerLoop: 16,
    view: 'grid',
